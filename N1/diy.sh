...
git clone  https://github.com/linkease/nas-packages-luci/luci/luci-app-linkease.git package/luci-app-linkease
git clone  https://github.com/linkease/nas-packages/network/services/linkease.git package/linkease
